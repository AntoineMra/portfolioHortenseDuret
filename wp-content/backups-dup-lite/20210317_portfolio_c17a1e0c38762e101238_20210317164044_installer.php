...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210317_portfolio_c17a1e0c38762e101238_20210317164044_archive.zip';
	const ARCHIVE_SIZE		 = '94779259';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'c17a1e0-17164044';
    const SECONDARY_PACKAGE_HASH = 'fed9373-17164044';
	const VERSION			 = '1.4.0';
